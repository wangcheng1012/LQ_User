...
public class EaseConstant {
    ...
    public static final String EXTRA_USER_ID = "otherid";                    //对方的环信id
    public static final String EXTRA_MY_ID = "fromid";                        //发送者环信id

    public static final String EXTRA_USER_NICK_NAME = "otherNickName";       //对方昵称
    public static final String EXTRA_USER_HEAD_IMG = "otherHeadImg";         //对方头像
    public static final String EXTRA_MY_NICK_NAME = "fromNickName";           //发送者昵称
    public static final String EXTRA_MY_HEAD_IMG = "fromHeadImg";             //发送者头像
