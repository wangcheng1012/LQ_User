...
//            mGroupID = fragmentArgs.getString(EaseConstant.EXTRA_GROUP_ID);
    ...
    protected void sendMessage(EMMessage message) {
        ...
        message.setAttribute(EaseConstant.EXTRA_MY_HEAD_IMG, mHeadimg);
        message.setAttribute(EaseConstant.EXTRA_MY_NICK_NAME, mNickname);
        message.setAttribute(EaseConstant.EXTRA_MY_ID, mId);
        message.setAttribute(EaseConstant.EXTRA_MY_UID, mUid);
    ...
    private String mHeadimg, mNickname, mId, mUid;

    private void getUserinfo() {
        SharedPreferences sp = getContext().getSharedPreferences("app", Context.MODE_PRIVATE);
        mHeadimg = sp.getString("headimg", "-1");
        mNickname = sp.getString("nickname", "-1");
        mId = sp.getString("hx_username", "-1");
        mUid = sp.getString("uid", "-1");
        System.out.println("发送的头像" + mHeadimg + "   " + mNickname + "    " + mId);
    }
